...
const tests = [
  ...
  path.join(__dirname, '..', 'tests', 'uploadProcessor.processFile.test.cjs'),
  path.join(__dirname, '..', 'tests', 'uploadProcessor.duplicates_strict.test.cjs')
  , path.join(__dirname, '..', 'tests', 'uploadProcessor.http.test.cjs')
  , path.join(__dirname, '..', 'tests', 'uploadProcessor.multipart.test.cjs')
  , path.join(__dirname, '..', 'tests', 'uploadProcessor.headersMap.test.cjs')
  , path.join(__dirname, '..', 'tests', 'uploadProcessor.merge.test.cjs')
